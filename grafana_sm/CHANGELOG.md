...
## [1.2.2](https://github.com/BroTEK-Solutions/ha-addons/compare/grafana-sm-v1.2.1...grafana-sm-v1.2.2) (2026-09-10)
...
## [1.2.1](https://github.com/BroTEK-Solutions/ha-addons/compare/grafana-sm-v1.2.0...grafana-sm-v1.2.1) (2026-08-29)


### Bug Fixes

* **deps:** update grafana/synthetic-monitoring-agent docker tag to v0.64.2 ([#82](https://github.com/BroTEK-Solutions/ha-addons/issues/82)) ([6a605d7](https://github.com/BroTEK-Solutions/ha-addons/commit/6a605d783e2da8cca3444e4fe7839fb20a140aca))
...
Initial release of Grafana Synthetic Monitoring Probe.
