...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 OpenBao permission set agent-docs-drift-brotek-solutions exists (installation_id 152180795, repositories=ha-addons, permissions=contents=read)
- [ ] #2 Policy gha-agent-docs-drift grants read on github-app-broker/token/agent-docs-drift-brotek-solutions
